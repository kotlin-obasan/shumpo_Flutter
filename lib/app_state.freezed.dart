...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Map<String, dynamic>> imageList});
}
...
class _$_AppState implements _AppState {
  const _$_AppState({final List<Map<String, dynamic>> imageList = const []})
  ...
  @override
  String toString() {
    return 'AppState(imageList: $imageList)';
  }
...
abstract class _AppState implements AppState {
  const factory _AppState({final List<Map<String, dynamic>> imageList}) =
      _$_AppState;
